...
def main():
    while True:
        try:
            # logic for giving the player the option to choose
            # between a computer controlled opponent or another person
...
# a much more basic version of def main() in
# this section was derived from code found on:
